      ...
      <aside
        ...
        <div className="h-20 flex items-center gap-3 px-6 border-b border-white/10">
          ...
          <div>
            ...
            <span className="text-xs text-amber font-medium tracking-wider uppercase">
              Admin Portal
            </span>
          </div>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive ? 'bg-white/10 text-amber border-l-4 border-amber font-medium' : 'text-cream/70 hover:bg-white/5 hover:text-white border-l-4 border-transparent'}`}>
        ...
        <div className="p-4 border-t border-white/10">
          <div className="flex items-center gap-3 px-4 py-3 mb-2">
            <img
              src={user?.avatar}
              alt={user?.name}
              className="w-10 h-10 rounded-full border-2 border-amber" />
